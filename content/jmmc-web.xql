...
declare function jmmc-web:navbar-li($node as node(), $model as map(*)) as node() {
  <li class="dropdown">
    <a href="#" class="dropdown-toggle" style="padding:12px;" data-toggle="dropdown"><img height="30" src="//jmmc.obs.ujf-grenoble.fr/images/jmmc_large.jpg" alt="JMMC logo"/>&#160;<span class="caret"></span></a>
